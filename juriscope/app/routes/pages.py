...
from app.auth.dependencies import get_current_user_optional, require_user, is_staff_mode_user
...
def build_usage_and_limits(user):
    ...
    if is_staff_mode_user(user):
        return {
            "usage": {"analyses": 0, "documents": 0, "cases": 0},
            "limits": {"analyses_per_month": 999999, "documents_per_month": 999999, "cases": 999999},
        }
...
def ctx(request: Request, extra: dict | None = None):
    ...
    data = {
        ...
        "is_unlimited_user": is_staff_mode_user(user),
